...
<v-container class="content-body pb-2">
  ...
  <v-row>
    <v-col cols="12" align="center">
      ...
      <p>In order to use this application, you will need the <a href="https://www.hashpack.app/">HashPack</a> browser extension wallet, as well as <a href="https://portal.hedera.com/register">Testnet account.</a>. Use the <b>Connect Wallet</b> button on the navbar.</p>
      <p>Future versions of this application will also allow players to use their <a href="https://hedera.com/account-creation">Mainnet accounts.</a></p>
    </v-col>
  </v-row>
